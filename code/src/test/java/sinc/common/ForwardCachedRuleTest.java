...
class ForwardCachedRuleTest {
    ...
    void testFamilyRule1() {
        ...
        /* parent(?, ?) :- */
        final ForwardCachedRule rule = new ForwardCachedRule(kb, FUNCTOR_PARENT, cache);
        ...
        /* parent(X, ?) :- father(X, ?) */
        assertTrue(rule.boundFreeVars2NewVar(FUNCTOR_FATHER, 0, 0, 0));
    ...
    void testFamilyRule2() {
        ...
        /* parent(?, X) :- father(?, X) */
        assertTrue(rule.boundFreeVars2NewVar(FUNCTOR_FATHER, 1, 0, 1));
        assertTrue(rule.toString().contains("parent(?,X0):-father(?,X0)"));
    ...
    void testFamilyRule3() {
        ...
        /* grandParent(?, ?) :- */
        final ForwardCachedRule rule = new ForwardCachedRule(kb, FUNCTOR_GRANDPARENT, cache);
        ...
        assertTrue(rule.boundFreeVars2NewVar(FUNCTOR_PARENT, 0, 0, 0));
        ...
        assertTrue(rule.boundFreeVars2NewVar(FUNCTOR_PARENT, 1, 0, 1));
    ...
    void testFamilyRule4() {
        ...
        assertTrue(rule.boundFreeVars2NewVar(FUNCTOR_PARENT, 0, 1, 1));
    ...
    void testFamilyRule5() {
        ...
        assertTrue(rule.boundFreeVars2NewVar(FUNCTOR_FATHER, 0, 1, 1));
    ...
    void testFamilyWithCopy1() {
        ...
        assertTrue(rule1.boundFreeVars2NewVar(FUNCTOR_PARENT, 0, 0, 0));
        ...
        assertTrue(rule1.boundFreeVars2NewVar(FUNCTOR_FATHER, 0, 1, 1));
        ...
        assertEquals(3, rule1.length());
        assertEquals(4, cache.size());
        ForwardCachedRule.UpdateResult update_result = rule1.updateInKb();
        final Set<List<Predicate>> actual_grounding_set = new HashSet<>();
        for (Predicate[] grounding: update_result.groundings) {
            actual_grounding_set.add(new ArrayList<>(Arrays.asList(grounding)));
        }
        ...
        assertFalse(rule2.boundFreeVars2NewVar(FUNCTOR_PARENT, 0, 0, 0));
        assertEquals(4, cache.size());

        /* #3: grandParent(?, X) :- father(?, X) */
        final ForwardCachedRule rule3 = new ForwardCachedRule(rule);
        assertTrue(rule3.boundFreeVars2NewVar(FUNCTOR_FATHER, 1, 0, 1));
        ...
        assertTrue(rule3.boundFreeVars2NewVar(FUNCTOR_PARENT, 0, 0, 0));
    ...
    void testFamilyWithCopy2() {
        ...
        /* #1: parent(?, ?) :- */
        final ForwardCachedRule rule1 = new ForwardCachedRule(kb, FUNCTOR_PARENT, cache);
        ...
        assertEquals(1, rule2.length());
        assertEquals(3, cache.size());
        ForwardCachedRule.UpdateResult update_result2 = rule2.updateInKb();
        ...
        assertEquals(2, rule3.length());
        assertEquals(4, cache.size());
        ForwardCachedRule.UpdateResult update_result3 = rule3.updateInKb();
