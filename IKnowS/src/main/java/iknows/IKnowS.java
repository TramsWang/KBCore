...
import iknows.util.graph.BaseGraphNode;
import iknows.util.graph.FeedbackVertexSetSolver;
import iknows.util.graph.Tarjan;
...
public abstract class IKnowS {
    ...
    protected final IknowsConfig config;
    ...
    public IKnowS(IknowsConfig config, String kbPath, String dumpPath, String logPath) {
        this.config = config;
        this.kbPath = kbPath;
    ...
    public boolean validate() {
        IknowsRecovery recovery = new IknowsRecovery(hypothesis, startSet, counterExamples, supplementaryConstants);
